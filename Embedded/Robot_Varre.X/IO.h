...
#define MOTEUR_DROITE_INL MOTEUR0_IN1
#define MOTEUR_DROITE_INH MOTEUR0_IN2
...
#define MOTEUR0_IN1 _LATC6
#define MOTEUR0_IN2 _LATC7
...
#define MOTEUR_DROITE_H_IO_OUTPUT MOTEUR0_IN1
#define MOTEUR_DROITE_L_IO_OUTPUT MOTEUR0_IN2
